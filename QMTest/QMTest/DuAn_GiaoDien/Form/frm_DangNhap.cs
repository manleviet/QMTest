    ...
    public partial class frm_DangNhap : XtraForm
    {
        ...
        private void btn_DangNhap_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                sys.Gv.IdGiaoVien = GetIdGiaoVien;
                sys.Gv.TenGiaoVien = dt.Rows[0]["TenGiaoVien"].ToString();
                sys.MoTa = "Đăng nhập hệ thống";
                ...
                GiaoVien.TenGiaoVien = dt.Rows[0]["TenGiaoVien"].ToString();
                Form1 frm = new Form1();
                frm.Show();
                this.Hide();
            }
